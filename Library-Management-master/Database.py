...
def DatabaseCreate():
    cnx = mysql.connector.connect(username='root', password='123', host='localhost')
    Cursor = cnx.cursor()
...
def TablesCreate():
    cnx = mysql.connector.connect(username='root', password='123', host='localhost', database='Library')
    Cursor = cnx.cursor()
